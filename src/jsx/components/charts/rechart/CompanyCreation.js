...
const CompanyCreation = ({activeTab}) => {
 ...
 const [setting, setSetting] = useState(false)
                  ...
                  <>
                    ...
                    >
                      ...
                      <img
                        src={
                          e?.user?.image
                            ? "https://bankerbroker.dev-mn.xyz/uploads/user_profile/" +
                              e?.user?.image
                            : Gandipicture
                        }
                        alt="No Img"
  ...
  const onUpdate = () => {
    ...
    Update.append(
      "label",
      nodeName ? nodeName : ModelArray?.company_details?.label
    );
    Update.append(
      "address",
      nodeaddress ? nodeaddress : ModelArray?.company_details?.address
    );
    Update.append("fax", nodefax ? nodefax : ModelArray?.company_details?.fax);
    Update.append(
      "phone",
      nodephone ? nodephone : ModelArray?.company_details?.phone
    );
    Update.append("profile_image", profileimg ? profileimg : "");

    Update.append("file", imageFiles ? imageFiles : "");
    Update.append(
      "admins",
      nodeadmin ? nodeadmin : ModelArray?.company_details?.admins
    );
    Update.append(
      "brokers",
      nodebroker ? nodebroker : ModelArray?.company_details?.brokers
    );
    var config = {
      method: "post",
  ...
  const handleProfile = (acceptedFiles) => {
              ...
              <div className="container">
                <div className="row">
                  <div className="col-md-6 my-2">
                    ...
                    <input
                      defaultValue={ModelArray?.company_details?.label}
                  ...
                  <div className="col-md-6 my-2">
                    ...
                    <input
                      defaultValue={ModelArray?.company_details?.phone}
                      type="number"
                      className="form-control"
                  ...
                  <div className="col-md-6 my-2">
                    ...
                    <input
                      defaultValue={ModelArray?.company_details?.address}
                      className="form-control"
                  ...
                  <div className="col-md-6 my-2">
                    ...
                    <input
                      defaultValue={ModelArray?.company_details?.fax}
                      type="tel"
                      className="form-control"
                  ...
                  <div className="col-md-6 my-2">
                    ...
                    <input
                      defaultValue={ModelArray?.company_details?.admins}
                      className="form-control"
                      type="number"
                  ...
                  <div className="col-md-6 my-2">
                    ...
                    <input
                      defaultValue={ModelArray?.company_details?.brokers}
                      className="form-control"
                      type="number"
                  ...
                  <div className="col-md-6 my-2">
                    ...
                    <ReactDropzone onDrop={handleProfile}>
                      {({ getRootProps, getInputProps }) => (
                        <section>
                          <div {...getRootProps()}>
                            <input {...getInputProps()} multiple={false} />
