      ...
      <div className="dndflow">
        <ReactFlowProvider>
                            ...
                            <>
                              <div className="col-md-6 my-2">
                                ...
                                <input
                                  ...
                                  onChange={(e) => setNodeName(e.target.value)}
                                  defaultValue={
                                    ModelArray?.company_details?.label
                                  }
                                />
                              </div>
                              <div className="col-md-6 my-2">
                                ...
                                <input
                                  ...
                                  defaultValue={
                                    ModelArray?.company_details?.phone
                                  }
                                />
                              </div>
                              <div className="col-md-6 my-2">
                                ...
                                <input
                                  ...
                                  defaultValue={
                                    ModelArray?.company_details?.address
                                  }
                                />
                              </div>
                              <div className="col-md-6 my-2">
                                ...
                                <input
                                  ...
                                  defaultValue={
                                    ModelArray?.company_details?.fax
                                  }
                                />
                              </div>
                              <div className="col-md-6 my-2">
                                ...
                                <input
                                  ...
                                  defaultValue={
                                    ModelArray?.company_details?.admins
                                  }
                                />
                              </div>
                              <div className="col-md-6 my-2">
          ...
          {settingToggle === false ? (
            <button
              type="button"
              class="btn btn-primary togglebtn2 rounded-0"
              onClick={() => {
                setSetting(!setting);
            ...
            <button
              type="button"
              class="btn btn-secondary togglebtn2 rounded-0"
              onClick={() => {
                setSetting(!setting);
                setSettingToggle(!settingToggle);
              }}
          ...
          <aside
            style={
              setting === true ? { display: "block" } : { display: "none" }
            }
          >
