  ...
  return (
    <>
      <div className="row">
        {
           Details?.role_id === 1
           ? <h2 className="text-dark w3-animate-left mb-3">welcome to Super Admin</h2>
           : Details?.role_id === 2
           ? <h2 className="text-dark w3-animate-left mb-4">welcome to Company</h2>
           : Details?.role_id === 3
           ? <h2 className="text-dark w3-animate-left mb-4">welcome to Company admin</h2>
           : Details?.role_id === 4
           ? <h2 className="text-dark w3-animate-left mb-4">welcome to Company Broker</h2>
           : Details?.role_id === 5
           ? <h2 className="text-dark w3-animate-left mb-4">welcome to Company teams</h2>
           : Details?.role_id === 7
           ? <h2 className="text-dark w3-animate-left mb-4">welcome to Company Agent</h2>
           : Details?.role_id === 7
           ? <h2 className="text-dark w3-animate-left mb-4">welcome to Company MLO</h2>
           : null
        }
        <div className="col-xl-3 col-sm-6">
          <div className="card gradient-1 card-bx shadow">
        ...
        <div className="col-xl-3 col-sm-6">
          <div className="card gradient-2 card-bx shadow">
            <div className="card-body d-flex align-items-center">
              <div className="me-auto text-white">
        ...
        <div className="col-xl-3 col-sm-6">
          <div className="card gradient-3 card-bx shadow">
            <div className="card-body d-flex align-items-center">
              <div className="me-auto text-white">
        ...
        <div className="col-xl-3 col-sm-6">
          <div className="card gradient-4 card-bx shadow">
            <div className="card-body d-flex align-items-center">
              <div className="me-auto text-white">
