...
const Header = ({ onNote }) => {
  ...
  let lastElement = getmessages[getmessages?.length - 1];
  ...
  useEffect(() => {
    ...
    channel.bind("send", (data) => {
      console.log(
        lastElement?.to_user == localStorage.getItem("nodeIds"),
        localStorage.getItem("nodeIds"),
        lastElement?.to_user,
        "lastelements"
      );
      setGetMessages((perv) => [...perv, data.data]);
      if (lastElement?.to_user == localStorage.getItem("nodeIds")) {
  ...
  console.log(getmessages, "getgetmessages");
  ...
  const BankerLogoBg = require("../../../images/removebg.png");
      ...
      <div className="header-content">
        <nav className="navbar navbar-expand">
          <div className="collapse navbar-collapse justify-content-between">
            <div className="header-left">
              ...
              >
                <img
                  ...
                  src={
                    Details?.role_id !== 1
                      ? Imgbaseurl.imgbaseurl + Details?.c_details?.file
                      : BankerLogoBg
                  }
            ...
            <ul className="navbar-nav header-right main-notification justify-content-center align-items-center">
              ...
              {/* <li className={`${path === "dashboard" ? "mm-active" : ""}`}>
                <Link
                  className={`${path === "dashboard" ? "mm-active" : "dashboard"}`}
                  to="/dashboard"
                >
                  {" "}

                  <span className="nav-text mt-3">Dashboard</span>
                </Link>
              </li> */}
              {/* <li>
                <Link
              ...
              >
                ...
                >
                  ...
                  {badge ? <div className="pulse-css"></div> : null}
                </Dropdown.Toggle>
              </Dropdown>
